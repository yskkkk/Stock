...
function mergeStockProcessEnv(mode) {
  ...
  for (const key of [
    ...
    "STOCK_HOLDINGS_CLOSE_DIGEST",
    "STOCK_HOLDINGS_CLOSE_DIGEST_TO",
    "STOCK_HOLDINGS_CLOSE_DIGEST_ALL_MEMBERS",
    "STOCK_HOLDINGS_CLOSE_DIGEST_POLL_MS",
    "STOCK_BOOK_ACCUM_FAST_BATCH",
    "STOCK_BOOK_ACCUM_FAST_BATCH_DELAY_MS",
    "STOCK_BOOK_ACCUM_FAST_YAHOO_CONCURRENT",
    "STOCK_BOOK_ACCUM_FAST_YAHOO_GAP_MS",
    "STOCK_BOOK_ACCUM_FAST_TIMEOUT_MS",
    "STOCK_BOOK_ACCUM_FAST_SCAN",
    "STOCK_NASDAQ_UNIVERSE_TARGET",
    "STOCK_TOSS_US_UNIVERSE_TARGET",
    "STOCK_SCAN_SESSION_CACHE_MS",
    "STOCK_SCAN_SESSION_MAX_KEYS",
  ]) {
