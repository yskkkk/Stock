...
export const ko = {
  ...
  valueInvest: {
    ...
    epsAtEnd: "10년차 EPS",
    formulasTitle: "계산 방식",
    formulaEpsAtEnd: "10년차 EPS = 기준 EPS(최대 10년 평균) × (1 + 성장률)^년수",
  ...
  stockVault: {
    ...
    scanRun: "일봉 탐색",
    scanConfirmLead: "일봉·주봉 골든크로스·정배열·120선 근처 탐색을 실행할까요?",
    scanConfirmBody:
      "국내 시총 상위·미국 S&P500 종목의 일봉·주봉에서 MA 교차(5→20·60·120 골든, 5↔20·20↔120 골든·데드), 정배열(MA5>20>60>120), 일봉 120선 ±3% 근처를 각각 찾아 보관함에 추가합니다. 수분 걸릴 수 있습니다.",
    scanConfirmOk: "탐색 시작",
  ...
  errors: {
    ...
    network: "서버에 연결할 수 없습니다. 네트워크·서버 상태를 확인한 뒤 다시 시도해 주세요.",
    parse: "서버 응답을 읽을 수 없습니다.",
    parseHtml:
      "서버가 갱신 중이거나 API에 연결되지 않았습니다. 잠시 후 다시 시도해 주세요.",
    request: "요청에 실패했습니다.",
  },
  screenFailures: {
    title: "조회 실패 종목",
