...
export const ko = {
  app: {
    ...
    liveTradeFieldTakeProfit: "목표 수익률 (%, 왕복 수수료 반영)",
    liveTradeFieldStopLoss: "손절 (%, 선택, 음수)",
    ...
    liveTradeSimRunEmpty: "가동 중인 시뮬이 없습니다. 프로그램에서 «시뮬 자동 시작»을 누르세요.",
    ...
    liveTradeSimRunTakeProfit: "목표 수익",
    liveTradeSimRunStopLoss: "손절",
