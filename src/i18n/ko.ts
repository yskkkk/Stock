...
export const ko = {
  ...
  stockVault: {
    title: "종목보관",
    desc: "일봉 골든크로스(MA5→20·60·120) 자동 탐지 종목과 수동 추가 종목을 관리합니다.",
    loading: "불러오는 중…",
    empty: "보관된 종목이 없습니다.",
    filterAria: "보관 필터",
    ...
    loginHint: "골든크로스 탐색 결과는 공통으로 보이며, 수동 추가·즐겨찾기·삭제는 계정별로 저장됩니다.",
    openTradingViewChart: "TradingView 차트 열기",
    removeFromVault: "보관함에서 제거",
    lastScan: "마지막 스캔",
    scanRun: "일봉 탐색",
    scanConfirmLead: "일봉 골든크로스 탐색을 실행할까요?",
    scanConfirmBody:
      "국내 시총 상위·미국 S&P500 종목의 일봉에서 MA5→20·60·120 골든크로스를 찾아 보관함에 추가합니다. 수분 걸릴 수 있습니다.",
    scanConfirmOk: "탐색 시작",
