...
export const ko = {
  app: {
    ...
    tabBoxRange: "박스권",
    tabFinancials: "재무",
    tabUsAnnouncements: "발표",
    tabCompanyReport: "기업보고서",
    tabInfoBoard: "정보 게시판",
    tabStockVault: "종목보관",
    ...
    accountManageCashWeight: "비중 {pct}",
  ...
  companyReport: {
    title: "기업 심층 보고서",
    subtitle:
      "티커·종목명으로 검색해 한글 목차형 심층 보고서를 만들고, 저장된 목록에서 언제든 다시 봅니다.",
    searchLabel: "종목 검색",
    searchPlaceholder: "티커 또는 종목명 (예: AAPL, 삼성전자)",
    searching: "검색 중…",
    searchEmpty: "검색 결과가 없습니다.",
    searchFail: "종목 검색에 실패했습니다.",
    hotHint: "인기 종목을 고르거나 위에서 검색하세요.",
    generate: "보고서 생성",
    generatingShort: "생성 중…",
    generating: "{sym} 보고서 생성 중… (재무·공시 수집, 최대 수 분)",
    generateDone: "보고서가 저장되었습니다.",
    generateFail: "보고서 생성에 실패했습니다.",
    pleaseWait: "잠시만 기다려 주세요…",
    listTitle: "저장된 보고서",
    listEmpty: "아직 저장된 보고서가 없습니다. 왼쪽에서 종목을 골라 생성하세요.",
    count: "{n}건",
    loading: "목록 불러오는 중…",
    loadFail: "보고서 목록을 불러오지 못했습니다.",
    openFail: "보고서를 열지 못했습니다.",
    reload: "새로고침",
    backToList: "목록으로",
    delete: "삭제",
    deleteConfirm: "이 보고서를 삭제할까요?",
    deleteFail: "삭제에 실패했습니다.",
    tocHint: "목차 항목을 누르면 해당 섹션으로 이동합니다.",
    bodyEmpty: "본문이 비어 있습니다.",
  },
  usAnnouncement: {
    title: "미국 발표",
    subtitle:
    ...
    kindGovernance: "거버넌스",
    kindEarnings: "실적",
    watchlist: "관심 종목 (눌러 선택)",
    watchPlaceholder: "티커 추가 (예: AAPL)",
    watchAdd: "추가",
    seedDemo: "데모 카드",
    filters: "발표 종류",
    scanNow: "지금 스캔(등록)",
    ...
    loading: "불러오는 중…",
    empty:
      "아직 발표 카드가 없습니다. 관심 티커를 선택한 뒤 「티커 스캔·등록」을 누르세요.",
    count: "{n}건",
    vsConsensus: "컨센 대비",
    yoy: "전년 대비",
    consensusChg: "컨센 변동",
    ...
    aiLabel: "AI 해석",
    detailLabel: "자세한 설명",
    articleLabel: "AI 분석 전문",
    deepAnalysisLabel: "상세 분석",
    openHint: "카드를 눌러 분석 열기",
    openArticle: "{title} 분석 전문 열기",
    closeArticle: "닫기",
    backToList: "목록으로",
    articleEmpty: "아직 분석 전문이 없습니다. 스캔·새로고침 후 다시 열어 보세요.",
    deepTeaser: "상세 분석 열기",
