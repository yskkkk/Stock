...
export const ko = {
  app: {
    ...
    liveTradeExitCompactSuccess: "목표",
    liveTradeExitCompactFailure: "손절",
    ...
    liveTradePfPriceRequired: "체결 단가를 입력하세요.",
    liveTradePfOpenOrdersNote:
      "빗썸 거래소에 접수된 미체결·예약 주문입니다. 현재가는 빗썸 KRW 시세 기준입니다.",
    liveTradePfOpenOrdersEmpty: "미체결 주문이 없습니다.",
    liveTradePfOpenOrdersNoApi:
      "빗썸 API Key·Secret Key를 «빗썸 API 연동»에서 저장하면 미체결 주문을 조회할 수 있습니다.",
    liveTradePfOpenOrdersSimOnly: "",
    liveTradePfColOrderType: "유형",
    liveTradePfColOrderState: "상태",
    liveTradePfColRemaining: "미체결",
    liveTradePfCancelOrder: "주문 취소",
    liveTradePfCancelOrderConfirm: "이 주문을 취소할까요?",
    ...
    liveTradeAuthHint:
      "개인 비트썸·토스 API로만 주문합니다. 가입 시 이메일 인증이 필요하며, 이 주소로 알림도 보냅니다.",
    ...
    liveTradeAuthVerificationCode: "이메일 인증번호",
    ...
    liveTradeCredEnvTossHint:
      "서버 .env에 토스 키가 설정되어 있습니다. 아래에 개인 API를 저장하면 계정별로 사용할 수 있습니다.",
    liveTradeTossAccountLabel: "계좌 번호",
    liveTradeTossAccountPlaceholder: "비워두면 기존 값 유지",
    ...
    leftRailAria: "좌측 보조 패널",
    leftRailBithumbAccountAria: "Bithumb 계좌 잔고·보유",
    ...
    liveTradeActivitySub:
      "실매매·시뮬 프로그램의 보유·목표가·최근 체결을 20초마다 갱신합니다. 실매매(빗썸)는 거래소 잔고·체결 API와 맞춥니다.",
  ...
  crypto: {
    panelTitle: "주요 코인 (Binance USDT · 24h 거래대금 순)",
    priceDisplayAria: "시세 표시 통화",
    priceKrw: "원",
    priceUsdt: "$",
    listAria: "코인 선택",
    listVolShort: "거래대금",
    listVolTitle: "24h 거래대금 (KRW·내림차순 정렬)",
  ...
  access: {
    ...
    adminTabLiveTrade: "실매매·시뮬",
    adminTabListAria: "관리자 메뉴",
    adminLiveTradeSummary: "서버 전체 · 실매매 {armed} · 시뮬 {sim}",
    adminLiveTradeEmpty: "가동 중인 실매매·시뮬 프로그램이 없습니다.",
    adminLiveTradeReload: "목록 새로고침",
    ...
    adminLiveTradeOpenPortfolio: "수익률 포트폴리오 보기",
    adminLiveTradeOpenPortfolioHint: "실매매 탭에서 이 프로그램 포트폴리오 열기",
    liveTradePfAdminView: "관리자 조회 · {name}",
