...
export const ko = {
  ...
  access: {
    ...
    vuIntro:
      "가상 사용자가 Playwright로 실제 브라우저를 클릭하며 UX를 점검합니다. 실주문·돈이 나가는 API는 이중 차단됩니다. 「구현」은 기록 모드 큐→Cursor 에이전트, 「백업」은 피드백 스냅샷 저장, 생성 시 OPS 텔레그램 알림이 갑니다.",
    vuPersonas: "페르소나",
    vuFeedback: "피드백 목록",
    vuFeedbackEmpty: "피드백이 없습니다. 「가상 사용자 실행」을 눌러 주세요.",
    vuReload: "새로고침",
    vuRun: "가상 사용자 실행 (브라우저)",
