...
export const ko = {
  app: {
    ...
    liveTradeSub:
      "추천 목록에서 만든 기술 분석 모델을 선택하여 토스 API 연동 실매매를 등록합니다.",
    ...
    liveTradeNoModels:
      "등록된 기술 모델이 없습니다. 추천 목록 탭에서 모델을 만든 뒤 사용하세요.",
    ...
    liveTradeListEmpty:
      "등록된 실매매 프로그램이 없습니다. 왼쪽에서 모델을 골라 등록하세요.",
    ...
    recTrackerUpgradeIntro:
      "텔레그램 알림 종목 실적에서 승률이 높은 근거는 가중치를 올리고, 낮은 근거는 내립니다. 적용 시 스크리너·알림 점수 산정에 반영됩니다.",
    recTrackerUpgradeBaseline: "알림 종목 승률 {rate} (승패 {decided}건)",
    recTrackerUpgradeMaxScore: "현재 최대 가중 점수 {n}점",
    recTrackerUpgradeHeadline: "우선 제안",
    recTrackerUpgradeNone: "지금 조건에서 조정할 근거가 없습니다. 데이터가 쌓이면 제안이 갱신됩니다.",
    recTrackerUpgradeApplyOne: "이 방안으로 업그레이드",
    recTrackerUpgradeApplyAll: "제안 전체 적용",
    ...
    recTrackerModelsActive: "스크리너·알림에 사용할 모델 (복수 선택)",
    recTrackerModelsActiveSaved: "활성 모델을 저장했습니다.",
    recTrackerModelsEditTarget: "가중치 편집·업그레이드 대상",
    recTrackerModelsNewNamePh: "새 모델 이름",
    recTrackerModelsSaveAs: "현재 설정으로 새 모델",
