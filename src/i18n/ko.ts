...
export const ko = {
  app: {
    ...
    accountManageStyleChartTitle: "성장·가치 성향",
    ...
    accountManageRebalancePreview: "예정 주문 미리보기",
    ...
    accountManageRebalanceMarketOffHint: "이 시장은 꺼져 있어 실행하지 않습니다.",
    accountManageRebalanceCashSummary: "계좌 현금 요약",
