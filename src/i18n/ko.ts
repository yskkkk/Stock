...
export const ko = {
  app: {
    ...
    liveTradeAutoExitHint: "매수 시 일봉으로 목표·손절가를 설정하고, 매도 전략(단기·중기·장기)에 따라 RSI·MACD·지지 이탈·트레일링·보유 한도 등 사유로 자동 청산합니다.",
    ...
    liveTradeArmedWaitBithumb:
      "빗썸 실매매 대기입니다. «실주문 허용»을 켜고 연결 테스트를 확인한 뒤 다시 시도하세요.",
    liveTradeArmedWaitBithumbKeys:
      "빗썸 API Key·Secret을 위 «빗썸 API 연동»에 저장한 뒤 «빗썸 실매매 시작»을 누르세요.",
    liveTradeArmedOkBithumb:
      "코인 실매매를 시작했습니다. 조건 충족 시 저장한 빗썸 키로 KRW 시장가 매수가 실행됩니다.",
    ...
    liveTradeCredOrderModeHint:
      "앱 안 «시뮬 자동 시작» 프로그램은 API만 저장되어 있으면 실주문 허용 여부와 관계없이 돌아갑니다. 여기 설정은 빗썸·토스에 실제 주문을 넣을지 여부입니다.",
    ...
    liveTradeFieldSellHorizon: "매도 전략 (투자 기간)",
    liveTradeSellHorizonShort: "단기 (잠깐~1–2일)",
    liveTradeSellHorizonMedium: "중기 (스윙)",
    liveTradeSellHorizonLong: "장기 (가치)",
    ...
    stockLookupAnalysisInsufficient:
      "일봉 데이터가 부족합니다(현재 {n}봉, 최소 55봉 필요).",
